...
namespace _4_DAL_CRM
{
    public class ServerConnection
    {
            ...
            if (addConfig)
            {
                ...
                if (config.ServerAddress.EndsWith(".dynamics.com", StringComparison.InvariantCultureIgnoreCase))
                {
                    ...
                    if (GetOrgType(config.ServerAddress))
                    {
                        ...
                        config.DiscoveryUri = new Uri("https://disco.crm4.dynamics.com/XRMServices/2011/Discovery.svc");
                        //config.DiscoveryUri = new Uri("https://disco.crm.dynamics.com/XRMServices/2011/Discovery.svc");
                    }
                    else
                    {
                        config.DiscoveryUri =
            ...
            switch (config.EndpointType)
            {
                ...
                case AuthenticationProviderType.OnlineFederation:
                   ...
                   ;
                    ...
                    credentials.UserName.Password = ConvertToUnsecureString(ssPassword);
                    break;
                default:
                    credentials = null;
                    break;
        ...
        protected virtual String GetServerAddress(out bool ssl)
        {
            ...
            String server = "lol.api.crm4.dynamics.com";
